		...
		<div class="content">
			...
			<div class="ds" >
				...
				<c:forEach var="saleorderProduct" items="${saleorderProduct}" >
					<tr>
						<td>${saleorderProduct.id}</td>
						<td>${saleorderProduct.saleorder_id}</td>
						...
						<td>${saleorderProduct.product_id}</td>
						<td>${saleorderProduct.quality}</td>
						
						<td>
						<a href="${base }/admin/detail-saleorder/${saleorder.id}" style="color:black;text-decoration: none"><span><i class="fas fa-shopping-cart"></i>Xem chi tiết</span></a>
						<a href="${base }/admin/del-saleorder/${saleorder.id}" style="color:black;text-decoration: none"><span><i class="fas fa-trash-alt"></i>Hủy</span></a>
						</td>
